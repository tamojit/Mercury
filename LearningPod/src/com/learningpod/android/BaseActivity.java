...
public class BaseActivity extends Activity implements
	...
	private void menupopup(String detail) {
		...
		int width = (int) TypedValue.applyDimension(
				TypedValue.COMPLEX_UNIT_DIP, 416, getResources()
						.getDisplayMetrics());
		DisplayMetrics metrics = BaseActivity.this.getResources()
				.getDisplayMetrics();
			...
			closebutton3.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					{
						...
						findViewById(R.id.bac_dim_layout).setVisibility(View.GONE);
	...
	private void menudialog(String detail) {
		...
		WindowManager.LayoutParams wmlp = menuitempopup1.getWindow()
				.getAttributes();
		...
		menuitempopup1.show();
		/*
		 * LinearLayout closebutton1 =
		 * (LinearLayout)menuitempopup1.findViewById(R.id.closebutton1);
		 * closebutton1.setOnClickListener(new OnClickListener() {
		 * 
		 * @Override public void onClick(View v) { // TODO Auto-generated method
		 * stub { menuitempopup1.dismiss(); }
		 * 
		 * } });
		 */
	}
